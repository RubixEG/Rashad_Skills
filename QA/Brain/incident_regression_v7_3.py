...
OUT=ROOT/'QA/Certification/INCIDENT_REGRESSION_V7_3.json'
...
def main():
 ...
 add(tests,'current_manifest_v7_3',m.get('version')=='7.3.0' and m.get('certification_harness','').endswith('verify_skill_v7_3.py'),{'version':m.get('version'),'certification_harness':m.get('certification_harness')})
