...
OUT=ROOT/'QA/Certification/INCIDENT_REGRESSION_V7_2.json'
...
def main():
 ...
 add(tests,'incident_registry_unique_and_complete',len(ids)==len(set(ids)) and len(ids)>=15,len(ids))
 ...
 add(tests,'current_manifest_v7_2',m.get('version')=='7.2.0' and m.get('certification_harness','').endswith('verify_skill_v7_2.py'))
