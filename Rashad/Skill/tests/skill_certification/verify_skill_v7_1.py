...
# Identity/startup
ck('version_current_710','Current release: v7.1.0' in text('VERSION.md'))
for rel in ['SKILL.md','00_START_HERE.md','PROJECT_INSTRUCTIONS.md','00_CHAT_MIRROR_KERNEL/00_RASHAD_BOOTSTRAP.md','00_CHAT_MIRROR_KERNEL/24_VERSION_LAYER_RESOLUTION_AND_RETIREMENT_LEDGER.md']:
 ck('current_route_'+rel, ('v7.1' in text(rel) or 'v7.0.2' in text(rel)), rel)
...
ck('manifest_version',m['version']=='7.1.0')
ck('manifest_current_certification_harness',m.get('certification_harness')=='tests/skill_certification/verify_skill_v7_1.py',str(m.get('certification_harness')))
ck('manifest_current_certification_harnesses',set(['tests/skill_certification/verify_skill_v7_1.py','tests/skill_certification/red_team_skill_v7_1.py']).issubset(set(m.get('certification_harnesses',[]))),str(m.get('certification_harnesses')))
...
ck('authority_binding_declares_710',bind.get('skill_version')=='7.1.0')
cr=data('CERTIFICATION_REQUIREMENTS.json')
ck('cert_requirements_710',cr.get('version')=='7.1.0')
