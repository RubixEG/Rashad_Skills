...
# Identity/startup
ck('version_current_720','Current release: v7.2.0' in text('VERSION.md'))
...
ck('manifest_version',m['version']=='7.2.0')
ck('manifest_current_certification_harness',m.get('certification_harness')=='tests/skill_certification/verify_skill_v7_2.py',str(m.get('certification_harness')))
ck('manifest_current_certification_harnesses',set(['tests/skill_certification/verify_skill_v7_2.py','tests/skill_certification/red_team_skill_v7_2.py']).issubset(set(m.get('certification_harnesses',[]))),str(m.get('certification_harnesses')))
...
ck('authority_binding_declares_720',bind.get('skill_version')=='7.2.0')
cr=data('CERTIFICATION_REQUIREMENTS.json')
ck('cert_requirements_720',cr.get('version')=='7.2.0')
