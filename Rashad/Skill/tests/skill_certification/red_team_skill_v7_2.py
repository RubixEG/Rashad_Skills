...
record('A21_binding_current_v71',bind.get('skill_version')=='7.2.0',str(bind.get('skill_version')))
record('A22_certification_stale_701',cert.get('version')=='7.2.0',str(cert.get('version')))
...
record('A50_manifest_v71_current',manifest.get('version')=='7.2.0' and manifest.get('artifact_brain_version')=='3.3.0','manifest current')
record('A51_manifest_certification_harness_stale',manifest.get('certification_harness')=='tests/skill_certification/verify_skill_v7_2.py',str(manifest.get('certification_harness')))
record('A52_manifest_red_team_harness_stale','tests/skill_certification/red_team_skill_v7_2.py' in manifest.get('certification_harnesses',[]),str(manifest.get('certification_harnesses')))
...
record('A57_old_v71_harness_reactivated',manifest.get('certification_harness')=='tests/skill_certification/verify_skill_v7_2.py' and 'tests/skill_certification/verify_skill_v7_1.py' not in manifest.get('certification_harnesses',[]),str(manifest.get('certification_harnesses')))
