...
from delivery_test_fixtures_v7_2 import png,review,hyps,good_pptx,bad_pptx,page
...
def main():
    ...
    escaped=[x for x in a if x['status']!='BLOCKED']; out={'suite':'V7.2 User-Visible Artifact Delivery Red Team','status':'PASS' if not escaped else 'FAIL','blocked':len(a)-len(escaped),'total':len(a),'attacks':a}
