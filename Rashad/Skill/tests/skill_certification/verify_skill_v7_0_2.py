...
# Identity/startup
ck('version_current_702','Current release: v7.0.2' in text('VERSION.md'))
for rel in ['SKILL.md','00_START_HERE.md','PROJECT_INSTRUCTIONS.md','00_CHAT_MIRROR_KERNEL/00_RASHAD_BOOTSTRAP.md','00_CHAT_MIRROR_KERNEL/24_VERSION_LAYER_RESOLUTION_AND_RETIREMENT_LEDGER.md']:
 ck('current_route_'+rel, 'v7.0.2' in text(rel), rel)
...
ck('manifest_version',m['version']=='7.0.2')
...
# v7.0.2 split-brain/status/internal-visible-label hardening
ck('authority_binding_declares_702',bind.get('skill_version')=='7.0.2')
cr=data('CERTIFICATION_REQUIREMENTS.json')
ck('cert_requirements_702',cr.get('version')=='7.0.2')
