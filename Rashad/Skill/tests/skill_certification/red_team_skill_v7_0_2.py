...
record('A21_binding_stale_701',bind.get('skill_version')=='7.0.2',str(bind.get('skill_version')))
record('A22_certification_stale_701',cert.get('version')=='7.0.2',str(cert.get('version')))
...
record('A28_router_stale_701',router.get('version')=='7.0.2',str(router.get('version')))
qat=data('07_GOVERNANCE_AND_QA/73_V7_VISUAL_AND_EXECUTIVE_FAILURE_TAXONOMY.json')
record('A29_qa_taxonomy_stale_701',qat.get('version')=='7.0.2',str(qat.get('version')))
