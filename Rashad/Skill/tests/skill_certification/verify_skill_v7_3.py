...
# Identity/startup
ck('version_current_730','Current release: v7.3.0' in text('VERSION.md'))
for rel in ['SKILL.md','00_START_HERE.md','PROJECT_INSTRUCTIONS.md','00_CHAT_MIRROR_KERNEL/00_RASHAD_BOOTSTRAP.md','00_CHAT_MIRROR_KERNEL/24_VERSION_LAYER_RESOLUTION_AND_RETIREMENT_LEDGER.md']:
 ck('current_route_'+rel, ('v7.3' in text(rel) or 'v7.2' in text(rel) or 'v7.1' in text(rel) or 'v7.0.2' in text(rel)), rel)
...
ck('manifest_version',m['version']=='7.3.0')
ck('manifest_current_certification_harness',m.get('certification_harness')=='tests/skill_certification/verify_skill_v7_3.py',str(m.get('certification_harness')))
ck('manifest_current_certification_harnesses',set(['tests/skill_certification/verify_skill_v7_3.py','tests/skill_certification/red_team_skill_v7_3.py']).issubset(set(m.get('certification_harnesses',[]))),str(m.get('certification_harnesses')))
...
ck('authority_binding_declares_730',bind.get('skill_version')=='7.3.0')
cr=data('CERTIFICATION_REQUIREMENTS.json')
ck('cert_requirements_730',cr.get('version')=='7.3.0')
...
ck('manifest_brain_runtime_350',m.get('brain_runtime_version')=='3.5.0')
ck('manifest_artifact_brain_400',m.get('artifact_brain_version')=='4.0.0')
...
# v7.3 visual production / engagement acceptance closure
ck('v73_visual_production_law_global','01_ACTIVE_RUNTIME/82_V7_3_VISUAL_PRODUCTION_ORGAN_AND_COMPOSITION_INTELLIGENCE_LAW.md' in m['global_authorities'])
ck('v73_remediation_qa_law_global','07_GOVERNANCE_AND_QA/85_V7_3_COUNCIL_SUPERVISED_REMEDIATION_AND_ENGAGEMENT_ACCEPTANCE.md' in m['global_authorities'])
ck('v73_workflow_global','05_WORKFLOW_ENGINE/26_V7_3_COMPOSITION_TO_PRODUCTION_AND_ENGAGEMENT_ACCEPTANCE_WORKFLOW.md' in m['global_authorities'])
ck('v73_recipe_index_bound',m.get('visual_production_recipe_index')=='01_ACTIVE_RUNTIME/VISUAL_PRODUCTION_RECIPE_INDEX_V7_3.json')
ck('v73_composition_spec_runtime',m.get('page_composition_spec_runtime')=='../Brain/runtime/brain/composition_spec.py')
ck('v73_composer_runtime',m.get('production_composer_runtime')=='../Brain/runtime/brain/production/composer.py')
ck('v73_renderer_runtime',m.get('production_renderer_runtime')=='../Brain/runtime/brain/production/renderer.py')
ck('v73_imagery_director_runtime',m.get('imagery_director_runtime')=='../Brain/runtime/brain/imagery_director.py')
ck('v73_format_neutral_inspector',m.get('format_neutral_product_inspector')=='../Brain/runtime/brain/product_geometry.py')
ck('v73_quality_floors',m.get('quality_targets',{}).get('dominant_mass_min')==0.32 and m.get('quality_targets',{}).get('dominant_mass_max')==0.68 and m.get('quality_targets',{}).get('composition_distinct_ratio_min')==0.7 and m.get('quality_targets',{}).get('artifact_truth')==90 and m.get('quality_targets',{}).get('ceqs')==90)
ck('v73_qa_versions',m.get('qa_runtime_version')=='4.4' and m.get('qa_brain_version')=='1.4.0')
ck('v73_engagement_acceptance_rule','FIXTURE_CERTIFICATION_NEVER_SUBSTITUTES' in m.get('engagement_acceptance_rule',''))
ck('v73_skill_status',data('CURRENT_SKILL_STATUS.json').get('skill_version')=='7.3.0')
# output
